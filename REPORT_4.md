...
```
### Написал новый Residual class с padding = kernel_size // 2 и с отдельной логикой для 1x1 + 3x3.Создал 4 модели как в задании, также обучил их на 15 эпохах на Cifar10.
